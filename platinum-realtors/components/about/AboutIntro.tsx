...
const IMAGES = [
  { id: 1, src: image1, alt: "Marble room",    top: 18,  left: 160, width: 350, height: 200 },
  { id: 2, src: image2, alt: "Living room",    top: 128, left: 400, width: 250, height: 200 },
  { id: 3, src: image3, alt: "Dark kitchen",   top: 278, left: 158, width: 300, height: 148 },
  { id: 4, src: image4, alt: "Flowers kitchen",top: 395, left: 270, width: 255, height: 175 },
  { id: 5, src: image5, alt: "White kitchen",  top: 500, left: 450, width: 275, height: 175 },
];
  ...
  return (
    <>
      <style>{`
        ...
        /* Mobile grid images — hidden on desktop */
        .collage-grid {
          display: none;
        }
        ...
        @media (max-width: 480px) {
          ...
          /* Hide the absolute-positioned collage on mobile */
          .about-collage {
            display: none;
          }

          /* Show the simple grid instead */
          .collage-grid {
            display: grid;
          ...
          /* Make the first image span full width */
