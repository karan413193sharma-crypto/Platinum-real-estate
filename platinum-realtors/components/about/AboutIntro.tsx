...
const IMAGES = [
  ...
  { id: 5, src: "/images/a5.jpg", alt: "White kitchen",   top: 500, left: 450, width: 275, height: 175 },
];
      ...
      <section className="about-section">
        ...
        <div className="about-panels">
          <div className="about-panel">
            <p>At <span className="panel-brand">Platinum Realtors,</span> we help buyers, sellers, and investors navigate the real estate market with confidence. Our experienced team is dedicated to providing personalized solutions, market expertise, and exceptional service at every step.</p>
            <br />
            <p>Whether you're searching for your dream home or a <span className="panel-big-red">valuable<br />investment</span> opportunity, we are committed to making your property journey seamless, transparent, and rewarding.</p>
          </div>
          <div className="about-panel">
            <p>Our commitment to transparency, integrity, and client satisfaction has earned us the trust of homeowners, buyers, sellers, and investors alike. Whether you're looking for your</p>
            <br />
            <p><span className="panel-big-red-sm">dream home, or a commercial space,</span> We strive to deliver exceptional service, valuable insights, and lasting relationships built on trust and professionalism.</p>
          </div>
