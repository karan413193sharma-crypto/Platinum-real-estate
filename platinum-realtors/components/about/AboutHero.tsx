  ...
  return (
    <>
      <style>{`
        ...
        .about-hero__title { font-family: 'Playfair Display', serif; font-size: clamp(28px, 5vw, 52px); font-weight: 700; color: #fff; letter-spacing: 1px; text-align: center; line-height: 1.2; word-break: break-word; margin: 0; }
