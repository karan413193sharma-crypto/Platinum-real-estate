...
export default function Footer() {
  return (
    ...
    >
      ...
      <style>{`
        .footer { position: relative; width: 100%; min-height: 350px; background-size: cover; background-position: center -120px; background-repeat: no-repeat; padding: 0 80px 40px; box-sizing: border-box; }
        ...
        .contact-item { display: flex; align-items: center; gap: 10px; margin-bottom: 12px; font-size: 14px; width: 100%; padding-left: 0; }
