  ...
  return (
    <>
      <style>{`
        ...
        .navbar-wrapper { position: absolute; top: 53px; left: 81px; right: 81px; z-index: 1000; }
        .navbar { height: 100px; background: rgba(26, 48, 65, 0.15); border: 1px solid var(--red); display: flex; align-items: center; backdrop-filter: blur(4px); }
        ...
        .navbar-menu a.active { border: 1px solid var(--red); border-radius: 3px; color: var(--white); }
        ...
        .navbar-contact-btn { background: var(--red); color: var(--white); font-size: 14px; font-weight: 500; padding: 9px 24px; border-radius: 3px; border: none; cursor: pointer; transition: all 0.25s ease; text-decoration: none; display: inline-block; white-space: nowrap; flex-shrink: 0; }
