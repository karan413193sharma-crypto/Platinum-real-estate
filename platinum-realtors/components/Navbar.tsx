  ...
  return (
    <>
      <style>{`
        ...
        /* Indented sub-links under Properties */
        .mobile-sub a {
        ...
        /* Properties label row in mobile (not a link, just a label) */
        .mobile-properties-label {
          font-size: 14px;
          font-weight: 400;
          color: var(--white);
          padding: 12px 14px;
        ...
        /* ── Small Tablet: 600px – 768px ─
           Show hamburger, hide nav links & contact btn ── */
      ...
      <div className="navbar-wrapper">
            ...
            <div className="navbar-menu">
              ...
              >
                ...
                <div className={`dropdown-menu ${propertiesOpen ? "open" : ""}`}>
                  <Link href="/commercial" className={pathname === "/commercial" ? "active" : ""}>
                    Commercial
                  </Link>
        ...
        <div className={`mobile-menu ${menuOpen ? "open" : ""}`}>
          ...
          <div className="mobile-sub">
            <Link href="/commercial" className={pathname === "/commercial" ? "active" : ""} onClick={() => setMenuOpen(false)}>
              Commercial
            </Link>
            <Link href="/residential" className={pathname === "/residential" ? "active" : ""} onClick={() => setMenuOpen(false)}>
              Residential
            </Link>
          </div>
