  ...
  return (
    <>
      <style>{`
        ...
        .com-hero-left { width: 45%; background: #1a1a1a; display: flex; flex-direction: column; justify-content: flex-end; padding: 60px 48px; position: relative; z-index: 2; }
        ...
        .com-hero-desc { font-size: 13px; color: rgba(255,255,255,0.65); line-height: 1.6; max-width: 280px; border: 1px solid rgba(255,255,255,0.15); padding: 14px 16px; margin-bottom: 28px; }
