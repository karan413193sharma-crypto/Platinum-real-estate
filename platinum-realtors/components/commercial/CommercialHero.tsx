...
export default function CommercialHero() {
  return (
    <>
      <style>{`
        .ch-hero { position: relative; width: 100%; height: 100vh; min-height: 500px; overflow: hidden; display: flex; align-items: center; }
        .ch-bg { position: absolute; inset: 0; z-index: 0; filter: grayscale(100%); }
        .ch-overlay-red { position: absolute; inset: 0; z-index: 1; background: linear-gradient(to right, rgba(160,10,10,0.72) 0%, rgba(160,10,10,0.55) 28%, rgba(120,10,10,0.18) 48%, transparent 65%); }
        .ch-overlay-dark { position: absolute; inset: 0; z-index: 2; background: linear-gradient(to right, rgba(0,0,0,0.55) 0%, rgba(0,0,0,0.25) 30%, transparent 55%); }
        .ch-content { position: relative; z-index: 3; padding: 0 48px; max-width: 520px; }
        ...
        .ch-desc { background: rgba(0,0,0,0.52); padding: 16px 18px; max-width: 290px; margin-bottom: 32px; border-radius: 2px; }
        ...
        @media (max-width: 767px) { .ch-hero { height: 70vh; min-height: 460px; align-items: flex-end; padding-bottom: 48px; } .ch-overlay-red { background: linear-gradient(to right, rgba(160,10,10,0.78) 0%, rgba(160,10,10,0.60) 40%, rgba(120,10,10,0.25) 65%, transparent 85%); } .ch-content { padding: 0 24px; max-width: 100%; } .ch-title { font-size: 48px; letter-spacing: -0.5px; } .ch-pre, .ch-post { font-size: 22px; } .ch-desc { max-width: 340px; margin-bottom: 24px; } }
        @media (max-width: 599px) { .ch-hero { height: 80svh; min-height: 520px; align-items: flex-end; padding-bottom: 40px; } .ch-overlay-red { background: linear-gradient(to bottom, rgba(120,10,10,0.10) 0%, rgba(140,10,10,0.50) 40%, rgba(160,10,10,0.82) 100%); } .ch-overlay-dark { background: linear-gradient(to bottom, transparent 30%, rgba(0,0,0,0.45) 100%); } .ch-content { padding: 0 20px; max-width: 100%; } .ch-pre { font-size: 18px; } .ch-title { font-size: 40px; letter-spacing: -0.5px; } .ch-post { font-size: 18px; margin-bottom: 20px; } .ch-desc { max-width: 100%; padding: 14px 16px; margin-bottom: 24px; } .ch-desc p { font-size: 13px; line-height: 1.65; } .ch-btn { width: 100%; text-align: center; padding: 14px 28px; font-size: 15px; } }
        @media (max-width: 380px) { .ch-hero { min-height: 480px; padding-bottom: 32px; } .ch-content { padding: 0 16px; } .ch-pre { font-size: 16px; } .ch-title { font-size: 34px; } .ch-post { font-size: 16px; margin-bottom: 16px; } .ch-desc { padding: 12px 14px; margin-bottom: 20px; } .ch-desc p { font-size: 12px; } .ch-btn { font-size: 14px; padding: 13px 24px; } }
      `}</style>
