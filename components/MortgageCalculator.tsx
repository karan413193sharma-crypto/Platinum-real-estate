...
function parseLacAmount(value: string) {
...
export default function MortgageCalculator() {
  ...
  const priceValue = parseLacAmount(propertyPrice);
  const downValue = parseLacAmount(downPayment);

  const remainingLoan =
    priceValue !== null && downValue !== null
      ? priceValue - downValue
      : null;

  const remainingLoanDisplay =
    remainingLoan !== null
      ? `Rs ${(remainingLoan / 100000).toLocaleString("en-IN", {
  ...
  const calculate = () => {
    ...
    const principal = (price ?? 0) - (down ?? 0);
    ...
    <>
      <style>{`
       ...
       font-family:Montserrat;
        ...
        /* =================================
           REMAINING LOAN (READ-ONLY, SAME STYLE AS OTHER FIELDS)
        ================================= */

        .mc-field-readonly label {
          display: block;
        ...
        <div className="mc-content">
          ...
          <div className="mc-card">
            ...
            <div className="mc-grid">
              ...
              {/* REMAINING LOAN AMOUNT (AUTO-CALCULATED) */}

              <div className="mc-field-readonly">

                <label htmlFor="mc-remaining-loan">
                  Loan Amount
                </label>

                <input
                  id="mc-remaining-loan"

                  value={remainingLoanDisplay}
