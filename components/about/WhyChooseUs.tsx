  ...
  return (
    <>
      <style>{`
        ...
        .wcu-heading { font-family: 'Playfair Display', serif; font-size: 30px; font-weight: 700; color: #c8102e; margin: 0 0 30px 0; text-align: center; }
        .wcu-grid { display: flex; gap: 50px; align-items: center; }
        .wcu-img-col { flex: 1; }
        .wcu-img { width: 100%; height: 420px; object-fit: cover; display: block; }
        .wcu-text-col { flex: 1; }
        .wcu-text { font-size: 13px; color: #333; line-height: 1.9; text-align: center; }
        .wcu-text p { margin: 0; }
        .wcu-spacer { margin-top: 14px !important; }
        @media (max-width: 1024px) and (min-width: 481px) {
          .wcu-section { padding: 40px 36px 60px; }
          .wcu-heading { text-align: center; }
          .wcu-grid { flex-direction: column; gap: 32px; }
        ...
        @media (max-width: 480px) {
          ...
          .wcu-grid { flex-direction: column; gap: 22px; }
