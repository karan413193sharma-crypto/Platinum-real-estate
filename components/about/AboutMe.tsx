  ...
  return (
    <section className="about-section">
      ...
      <style>{`
        ...
        .red-box { position: absolute; bottom: 0; border-radius: 230px 230px 0 0; left: 210px; width: 370px; height: 630px; border: 2px solid #c8102e; z-index: 1; }
        .content-column { width: 55%; flex: 1; display: flex; justify-content: center; text-align: center; padding-top: 10px; }
        .content-inner { max-width: 720px; }
        .content-column h2 { font-family: Playfair Display;  font-size: 46px; font-weight: 700; color: #c8102e; margin: 0 0 26px; }
        .content-column p { color: #fff; font-size: 16px; line-height: 1.55; margin: 0 0 20px; font-family: 
Montserrat; font-weight:regular }
        .content-column h4 {  font-family: Playfair Display;  font-size: 17px; font-weight: 600; color: #c8102e; margin: 20px 0 0; }
       /* ========================= */
/* Tablet */
/* ========================= */
