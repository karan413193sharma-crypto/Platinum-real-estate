  ...
  return (
    <>
      <style>{`
        ...
        .service-card-img-wrap { position: relative; width: 100%; height: 410px; overflow: hidden; }
...
background: linear-gradient(
  ...
  #A87A7A 100%
        ...
        .service-card-btn { background-color: #c8102e; color: #fff; border: none; padding: 10px 24px; font-size: 13px; cursor: pointer; letter-spacing: 0.02em; font-family:"Montserrat"; }
        ...
        <div className="services-grid">
          <div className="service-card">
            ...
            <div className="service-card-body serviceone">
              ...
              <p className="service-card-desc">Residential properties offer a premium lifestyle featuring modern high-rise apartments and luxury independent floors.</p>
          ...
          <div className="service-card ">
            ...
            <div className="service-card-body commercial servicetwo">
              ...
              <p className="service-card-desc">Commercial properties offer high-yielding real estate opportunities across premium retail spaces, modern office complexes, and dedicated IT parks.</p>
              <button className="service-card-btn">Explore Properties</button>
            </div>
          </div>
        </div>
